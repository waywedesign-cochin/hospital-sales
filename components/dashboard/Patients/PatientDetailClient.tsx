...
export default function PatientDetailClient({
  ...
  return (
    <div className=" space-y-6">
      {/* Header */}
      <div className="relative overflow-hidden rounded-3xl border border-slate-200 shadow-sm bg-white">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-6 relative z-10">
          ...
          <div className="flex items-center gap-2">
            <Button
              variant="outline"
              className="border-slate-200 text-slate-600 rounded-xl hover:bg-emerald-50 hover:text-emerald-700"
              onClick={() => {
                setEditForm({
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 flex flex-col gap-6">
          <Card className="border-0 shadow-xl shadow-black/10 rounded-3xl overflow-hidden bg-linear-to-br from-[#0D1117] via-[#141A21] to-emerald-900 text-white relative">
            ...
            <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-emerald-400/20 rounded-full blur-2xl pointer-events-none"></div>
            ...
            <div className="px-6 pb-8 pt-10 relative z-10 flex flex-col items-center text-center">
              <div className="w-24 h-24 bg-white/10 rounded-full border-4 border-white/20 shadow-xl flex items-center justify-center mb-5 backdrop-blur-md">
                <div className="w-full h-full bg-white rounded-full flex items-center justify-center text-[#0D1117] text-3xl font-extrabold shadow-inner">
              ...
              <h2 className="text-2xl font-bold mb-1 tracking-tight drop-shadow-md">
                {patient.firstName}{" "}
                {patient.lastName && patient.lastName !== "-"
                  ? patient.lastName
                  : ""}
              ...
              <div className="flex items-center gap-2 mb-6">
                <span className="text-slate-300 text-xs font-medium bg-black/20 px-3 py-1 rounded-full border border-white/10 shadow-sm backdrop-blur-md">
                ...
                {patient.appointments.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-16 text-center px-4">
                    ...
                    <p className="text-sm text-slate-500 max-w-sm mb-4">
                      This patient hasn't booked any appointments or treatments
                      yet.
                    </p>
                    <Button
                      className="bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl shadow-sm font-semibold"
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-3 text-xs text-slate-500">
                                <span className="flex items-center gap-1">
                                  ...
                                  {new Date(
                                    appt.date,
                                  ).toLocaleDateString()} at {appt.startTime}
                                </span>
                                {appt.doctor && (
                                  <span className="flex items-center gap-1">
                                    <User className="w-3 h-3" />
                                    {appt.doctor.prefix || "Dr."}{" "}
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <span
                                className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                                  enquiryStatusColors[enq.status] ||
                                  "bg-gray-100 text-gray-600"
                                }`}
                              >
              ...
              <CardHeader className="border-b border-slate-100 pb-4">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-lg text-slate-800 flex items-center gap-2">
                    <Activity className="w-5 h-5 text-emerald-600" /> Medical
                    Notes
                  </CardTitle>
                  <Button
                    size="sm"
                    className="bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-semibold"
              ...
              <CardContent className="p-0">
                {notesLoading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-16 text-center px-4">
                    ...
                    <p className="text-sm text-slate-500 max-w-sm mb-4">
                      Add consultation notes, diagnoses, prescriptions, or lab
                  ...
                  <div className="divide-y divide-slate-100">
                    {medicalNotes.map((note) => {
                      ...
                      return (
                        <div
                          key={note._id}
                          className="p-4 hover:bg-slate-50/30 transition-colors group"
                        >
                          <div className="flex items-start gap-3">
                            <div
                              className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 mt-0.5 ${typeInfo.color}`}
                            >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-3 text-xs text-slate-400">
                                ...
                                {note.doctor && (
                                  <span>
                                    • {note.doctor.prefix || "Dr."}{" "}
                                    {note.doctor.firstName}{" "}
                ...
                {NOTE_TYPES.map((t) => {
                  ...
                  return (
                    <button
                      key={t.value}
                      onClick={() =>
                        setNoteForm({ ...noteForm, type: t.value })
                      }
